...
const testCases = [
  ...
  { id: 'rx_azo_coupling_aniline', name: 'Azo Coupling (Yellow Dye)', inputs: ['C6H5N2Cl', 'C6H5NH2', 'pH 4-5'], conds: [] },
  ...
  { id: 'rx_aldol_condensation', name: 'Aldol Condensation', inputs: ['CH3CHO', 'NaOH'], conds: ['heat'] },
  { id: 'rx_cannizzaro', name: 'Cannizzaro Reaction', inputs: ['C6H5CHO', 'KOH'], conds: [] },
  { id: 'rx_clemmensen', name: 'Clemmensen Reduction', inputs: ['CH3COCH3', 'Zn_Hg', 'HCl'], conds: [] },
  { id: 'rx_tollens_test', name: "Tollens' Silver Mirror Test", inputs: ['CH3CHO', 'AgNO3', 'NH4OH', 'NaOH'], conds: ['warm_water_bath'] },
  { id: 'rx_fehling_test', name: "Fehling's Test", inputs: ['CH3CHO', 'CuSO4', 'NaOH'], conds: ['heat'] },
  { id: 'rx_iodoform_test', name: 'Iodoform Test', inputs: ['CH3COCH3', 'I2', 'NaOH'], conds: ['warm'] },
  { id: 'rx_finkelstein', name: 'Finkelstein Reaction', inputs: ['CH3CH2Cl', 'NaI', 'acetone'], conds: [] },
  { id: 'rx_swarts', name: 'Swarts Reaction', inputs: ['CH3Br', 'AgF'], conds: ['heat'] },
  { id: 'rx_wurtz', name: 'Wurtz Reaction', inputs: ['CH3Br', 'Na', 'dry_ether'], conds: [] },
  { id: 'rx_reimer_tiemann', name: 'Reimer-Tiemann Synthesis', inputs: ['C6H5OH', 'CHCl3', 'NaOH'], conds: ['heat'] },
  { id: 'rx_kolbe_schmitt', name: "Kolbe's Synthesis", inputs: ['C6H5OH', 'NaOH', 'CO2'], conds: ['heat'] },
  { id: 'rx_brown_ring', name: 'Brown Ring Test for Nitrates', inputs: ['NaNO3', 'FeSO4', 'H2SO4'], conds: [] },
  { id: 'rx_nessler_ammonium', name: "Nessler's Reagent Test", inputs: ['NH4Cl', 'K2HgI4', 'KOH'], conds: ['alkaline'] },
  { id: 'rx_chromyl_chloride', name: 'Chromyl Chloride Test', inputs: ['NaCl', 'K2Cr2O7', 'H2SO4'], conds: ['heat'] },
];
