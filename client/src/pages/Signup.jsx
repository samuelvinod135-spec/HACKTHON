...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (authErr) {
      ...
      if (data?.session) {
        ...
        setSuccessMsg('Account provisioned! Check your email to confirm, or proceed to the lab.');
  ...
  return (
    <div className="min-h-screen bg-[#f8fbff] flex flex-col justify-center py-8 sm:py-14 px-4 sm:px-6 relative overflow-hidden font-sans antialiased text-slate-800">
      ...
      <div className="absolute bottom-10 left-10 w-[250px] sm:w-[450px] h-[250px] sm:h-[450px] bg-amber-200/30 blur-3xl -z-10 rounded-full pointer-events-none" />
      ...
      <div className="w-full max-w-[440px] mx-auto relative z-10 pt-8 sm:pt-0">
        {/* Card */}
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div>
              ...
              <select
                ...
                className="input-sky-clean w-full px-3.5 py-2.5 sm:py-3 text-base sm:text-xs bg-white text-slate-800"
              >
            ...
            <p className="text-[11px] text-slate-500 leading-normal pt-1">
              By registering, you agree to the LabXplore Scientific Safety Guidelines and Student Privacy Charter.
            </p>
            ...
            >
              {loading ? (
                ...
                <>
                  <span>Create Free Student ID</span>
