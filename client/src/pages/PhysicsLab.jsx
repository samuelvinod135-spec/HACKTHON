          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-lg font-black tracking-tight text-slate-900">
                {t('physics.title', 'Physics Lab')}
              </h2>
              <span className="rounded-md bg-teal-100/80 border border-teal-200 px-2 py-0.5 text-[10px] font-extrabold text-teal-800">
                {t('physics.snellAndDynamics', "Snell's Law & Dynamics")}
              </span>
            </div>
            <p className="text-xs text-slate-400">
              {t('physics.subtitle', 'Interactive 2D Ray Tracing · Lens Maker Equation · Newtonian Mechanics')}
            </p>
          </div>
        </div>
