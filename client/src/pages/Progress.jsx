...
export default function Progress() {
  ...
  const hasHistory = (completions && completions.length > 0) || !!savedTestResults;
  ...
  const rawTopics = [
    {
      ...
      chapter: 'Ray Optics',
      subject: 'Physics',
      mockAccuracy: hasHistory ? (savedTestResults?.topicBreakdown?.['Ray Optics'] || 84) : 0,
      ebbinghausRetention: hasHistory ? 78 : 0,
      decayHours: hasHistory ? 18 : 0,
    },
    {
      topic: 'Thermodynamics & Carnot',
      chapter: 'Thermodynamics',
      subject: 'Physics',
      mockAccuracy: hasHistory ? (savedTestResults?.topicBreakdown?.['Thermodynamics'] || 42) : 0,
      ebbinghausRetention: hasHistory ? 38 : 0,
      decayHours: hasHistory ? 64 : 0,
    },
    {
      topic: 'Stoichiometry & Moles',
      chapter: 'Some Basic Concepts of Chemistry',
      subject: 'Chemistry',
      mockAccuracy: hasHistory ? (savedTestResults?.topicBreakdown?.['Stoichiometry'] || 68) : 0,
      ebbinghausRetention: hasHistory ? 64 : 0,
      decayHours: hasHistory ? 26 : 0,
    },
    {
      topic: 'Electrochemistry (Nernst)',
      chapter: 'Electrochemistry',
      subject: 'Chemistry',
      mockAccuracy: hasHistory ? (savedTestResults?.topicBreakdown?.['Electrochemistry'] || 74) : 0,
      ebbinghausRetention: hasHistory ? 72 : 0,
      decayHours: hasHistory ? 14 : 0,
    },
    {
      topic: 'Kinematics & Vectors',
      chapter: 'Kinematics',
      subject: 'Physics',
      mockAccuracy: hasHistory ? (savedTestResults?.topicBreakdown?.['Kinematics'] || 70) : 0,
      ebbinghausRetention: hasHistory ? 66 : 0,
      decayHours: hasHistory ? 22 : 0,
    },
    {
      topic: 'Organic Reaction Mechanisms',
      chapter: 'Organic Chemistry - Basic Principles & Techniques',
      subject: 'Chemistry',
      mockAccuracy: hasHistory ? (savedTestResults?.topicBreakdown?.['Organic'] || 45) : 0,
      ebbinghausRetention: hasHistory ? 39 : 0,
      decayHours: hasHistory ? 72 : 0,
    },
    {
      topic: 'Simple Harmonic Motion',
      chapter: 'SHM',
      subject: 'Physics',
      mockAccuracy: hasHistory ? (savedTestResults?.topicBreakdown?.['SHM'] || 62) : 0,
      ebbinghausRetention: hasHistory ? 58 : 0,
      decayHours: hasHistory ? 36 : 0,
    },
  ];
